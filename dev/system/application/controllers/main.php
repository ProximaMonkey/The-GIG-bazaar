...
class Main extends Controller {
	...
	function index()
	{
		...
		if($cookie)
		{
			...
			$user = json_decode(file_get_contents('https://graph.facebook.com/me?wrap_access_token='.$cookie['oauth_access_token']))->me;
			$user_check = $this->checkuser($user->email);
			...
			if($user_check == 'exists')
			{
				...
				//$this->register_user($user->id, $user->email, $user->name, $user->username);
