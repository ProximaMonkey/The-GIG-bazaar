...
class Main_model extends Model {
    ...
    <tr>
        <td height='18' width='666' bgcolor='#ffffff' style='background-image:url(images/top_shadow.png);width:666px;background-repeat:no-repeat;background-position:top;height:18xp;'>&nbsp;</td>
    </tr>
    <tr>
        <td style='background-image:url(images/middle_shadow.png);background-repeat:repeat-y;width:666px;height:370px;' height='371'>
        <table cellspacing='0' cellpadding='0' align='center'  width='638'>
     		<tr>
				<td height='104' width='500' style='background-image:url(images/top_bg.png);height:109px;background-repeat:repeat-x;'>   
...
<br>The Gig bazaar Team<br><br><b>If you have any queries regarding the email, please email us at <a href=mailto:support@thegigbazaar.com>support@thegigbazaar.com</a>
    ...
    <tr>
		<td height='10' bgcolor='#ffffff' style='background-image:url(images/bottom_shadow.png);background-repeat:no-repeat;background-position:bottom;height:17px;'>&nbsp;</td>
	</tr>
</table>";
