...
<div id="footer">
	<hr>
	<span>&copy; All Rights Reserved. <a href="<?php echo base_url();?>how_work.html">How it works</a> | <a href="<?php echo site_url('main/contactus');?>">Contact us</a> | <!--<a href="">Blog</a> |--> <a href="<?php echo site_url('main/terms');?>">Terms of Service</a></span>
