...
<h2>Post a Gig</h2>
	...
	<div class="form-error"><?php echo validation_errors(); ?></div>
		 <form action="<?php echo site_url('gig/addjob');?>" method="post" enctype="multipart/form-data">
			...
			<div class="holder">
				<div class="txt">I will </div><div class="f"><input class="text" id="quicktitle" name="quicktitle" type="text" value="<?php echo set_value('quicktitle'); ?>" maxlength='76'/></div><div class="txt">for <?php echo CURRENCY." ".MINIMUM_BALANCE;?></div>
			</div>
			</div>
			<ul>
<li><label>Category</label><div>				<select name="category"><?php echo $category_dropdown;?>
		...
		<li><label>Description</label><div><textarea name="jobdescription" id="area1" class="textarea medium msgpost"><?php echo set_value('jobdescription'); ?></textarea></div><span>			Be as descriptive as possible.
					...
					Define the extents of this gig - how many units, revisions, samples are included</span></li>
						...
						<li><label>Keywords / Tags</label><div><input type='text' class='text ssmall' name='tag1' maxlength='10'><input type='text' class='text ssmall' name='tag2' maxlength='10'><input type='text' class='text ssmall' name='tag3' maxlength='10'><input type='text' class='text ssmall' name='tag4' maxlength='10'><input type='text' class='text ssmall' name='tag5' maxlength='10'></div><span>Enter keywords that best describe your gig.
					...
					Example: stickers social marketing promotion </span></li>
						...
						<li><label>Maximum Days to complete</label><div><input type="text" name="maxdays" id="maxdays" class="text small" value="<?php echo set_value('maxdays'); ?>"></div><span>Maximum days to complete the task</span></li>
							...
							<li><label>What Information do you need to start this job?</label><div><textarea name="informationrequired" id="area2" class="textarea medium msgpost" id='informationrequired'><?php echo set_value('informationrequired'); ?></textarea></div><span>			Be as descriptive as possible.</span></li>
