...
<div id="order_page"><a href="<?php echo site_url('gig/order/'.$id);?>"><div  class="order_nowbutton">Order now</div></a><br/>
        ...
        <div class="clearleft"	></div>
				<div style='float:right;height:270px;'>
					<img src='<?php echo base_url();?>/assets/timthumb.php?src=<?php echo base_url().'/images/gigs/'.$gig['image'];?>&h=270&w=380&zc=1\'>
				</div>
				<div style="clear:both;"></div>
					...
					<div class="subsection">
						...
						<img src="<?php echo base_url();?>/user_avatar/<?php echo $person['image'];?>" width="70" height="50" style="float:left;padding:9px;"> 
						<?php }
						else {
						?>
							<img src="http://graph.facebook.com/<?php echo $person['facebook'];?>/picture" style="float:left;padding:9px;"> 
						<?php
						}?><h3><?php echo $person['name'];?><br/></h3>
