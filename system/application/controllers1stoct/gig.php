...
class Gig extends Controller {
	...
	function placeorder()
	{
		...
		if($orderid != "")
		{
			...
			$data = array('orderid'=>$randNum,'order_by'=>$this->session->userdata('id'),'order_for'=>$user_id,'gigid'=>$orderid,'payment_status'=>'1','order_date'=>$date);
